...
[![GitHub Actions status](https://github.com/backmarket-oss/helm-push-cloudflare-access/workflows/build/badge.svg)](https://github.com/backmarket-oss/helm-push-cloudflare-access/actions?query=workflow%3Abuild)
...
```
$ helm plugin install https://github.com/backmarket-oss/helm-push-cloudflare-access
Downloading and installing helm-push v0.10.4 ...
https://github.com/backmarket-oss/helm-push-cloudflare-access/releases/download/v0.10.4/helm-push_0.10.4_darwin_amd64.tar.gz
