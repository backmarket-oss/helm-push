...
if [ "$(uname)" = "Darwin" ]; then
    url="https://github.com/github.com/backmarket-oss/helm-push-cloudflare-access/releases/download/v${version}/helm-push_${version}_darwin_${arch}.tar.gz"
elif [ "$(uname)" = "Linux" ] ; then
    url="https://github.com/github.com/backmarket-oss/helm-push-cloudflare-access/releases/download/v${version}/helm-push_${version}_linux_${arch}.tar.gz"
else
    url="https://github.com/github.com/backmarket-oss/helm-push-cloudflare-access/releases/download/v${version}/helm-push_${version}_windows_${arch}.tar.gz"
fi
